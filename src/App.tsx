...
const SectionHeading = ({ badge, title, subtitle, centered = true }: { badge?: string, title: React.ReactNode, subtitle?: string, centered?: boolean }) => (
  ...
  return (
    <div className="w-full max-w-sm mx-auto bg-[#0b141a] rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
      <div className="bg-[#202c33] p-4 flex items-center gap-3">
        ...
        <div>
          <p className="font-bold text-sm">JusIn - Cálculo para Precatórios</p>
  ...
  return (
    <div className="min-h-screen selection:bg-brand selection:text-white">
      ...
      <main className="pt-32">
        ...
        <section className="relative pt-20 pb-32 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 text-center">
            <div>
              ...
              <h1 className="text-3xl md:text-6xl lg:text-7xl font-black mb-6 leading-[1.1] tracking-tight">
                Chega de depender de terceiros e planilhas duvidosas.
              </h1>
              <p className="text-brand text-xl md:text-2xl font-bold max-w-3xl mx-auto mb-12 leading-relaxed">
                Precifique precatórios com autonomia, valor correto e credibilidade.
              </p>
              ...
              <div className="flex flex-col items-center gap-6">
                <button 
                  ...
                  className="btn-primary text-base md:text-lg px-8 md:px-12"
                >
        ...
        <section className="py-16 bg-white/[0.02]">
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <SectionHeading 
                  title={<><span className="text-brand">Simples assim</span>: você envia o ofício requisitório do TJSP. A gente calcula. Você recebe pronto.</>}
                  centered={false}
                />

                <div className="space-y-6 mt-12">
                  <div className="flex items-center gap-6 p-6 glass-card hover:border-brand/50 transition-colors group">
                    ...
                    <div>
                      <h3 className="text-xl font-bold">Cálculos Atualizados</h3>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-6 p-6 glass-card hover:border-brand/50 transition-colors group">
                    ...
                    <div>
                      <h3 className="text-xl font-bold">Envio do Arquivo PDF no WhatsApp</h3>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-6 p-6 glass-card hover:border-brand/50 transition-colors group">
                    ...
                    <div>
                      <h3 className="text-xl font-bold">Redução de Risco</h3>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* Stats Section */}
        <section className="py-12 border-y border-white/5 bg-brand/5">
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
              <div className="flex flex-col items-center text-center p-8 glass-card border-brand/20 hover:border-brand/40 transition-all duration-500 group">
                <div className="w-16 h-16 rounded-2xl bg-brand/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
                  <TrendingUp className="w-8 h-8 text-brand" />
                </div>
                <h3 className="text-4xl md:text-6xl font-black text-brand mb-2 tracking-tighter">
                  + de <Counter value={20} suffix=" mil" />
                </h3>
                <p className="text-gray-400 text-lg md:text-xl font-medium uppercase tracking-widest">cálculos realizados</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center p-8 glass-card border-brand/20 hover:border-brand/40 transition-all duration-500 group">
                ...
                <p className="text-gray-400 text-lg md:text-xl font-medium uppercase tracking-widest">usuários atendidos</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="pricing" className="py-20 relative">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-6xl font-black mb-12">Assine nosso plano Profissional.</h2>

            <div className="glass-card p-12 border-brand/30 relative max-w-2xl mx-auto">
              <div className="flex flex-col items-center gap-4 mb-8">
                <Badge>🔥 Oferta Exclusiva do Mês</Badge>
                <Badge className="bg-brand/20 border-brand/40 text-brand">Somente para os primeiros dez usuários.</Badge>
              </div>

              <div className="mb-4">
                <div className="flex items-baseline justify-center">
                  <span className="text-2xl md:text-4xl font-bold text-brand mr-1">R$</span>
                  <p className="text-6xl md:text-9xl font-black text-brand">199</p>
                  <span className="text-3xl md:text-5xl font-black text-brand">,90</span>
                  <span className="text-xl md:text-2xl font-bold text-brand/60 ml-1">/mês</span>
                </div>
              </div>

              <a 
                href="https://pay.kiwify.com.br/jGa7p7E" 
                target="_blank" 
                rel="noopener noreferrer"
                className="btn-primary w-full text-lg md:text-xl mb-6 flex items-center justify-center gap-2"
              >
                Quero assinar <ArrowRight className="w-6 h-6" />
              </a>

              <div className="mt-12 mb-12 space-y-4 text-left max-w-md mx-auto border-t border-white/5 pt-8">
                {[
                  "1 usuário",
                  "20 cálculos mensais",
                  "Cálculo excedido: R$ 9,90",
                  "1h de treinamento sobre precatório"
                ].map((feature, idx) => (
                  <div key={idx} className="flex items-start gap-4">
                    <CheckCircle2 className="w-6 h-6 text-brand shrink-0 mt-0.5" />
                    <span className="text-gray-200 font-semibold text-lg md:text-xl">{feature}</span>
                  </div>
                ))}
              </div>
        ...
        <section className="py-16 bg-black/20">
          <div className="max-w-7xl mx-auto px-4">
            <SectionHeading 
              ...
              subtitle="Para sua total clareza, o JusIn é uma ferramenta especializada. Entenda o que não faz parte do nosso escopo:"
            />
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-8 glass-card border-red-500/10 hover:border-red-500/30 transition-colors group relative overflow-hidden">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  Não somos um sistema de gestão empresarial genérico. Focamos exclusivamente na inteligência de cálculos de precatórios.
                </p>
              </div>
              ...
              <div className="p-8 glass-card border-red-500/10 hover:border-red-500/30 transition-colors group relative overflow-hidden">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  Não somos um balcão de compra e venda de precatórios. Somos a ferramenta que você usa para precificar antes de negociar.
                </p>
              </div>
              ...
              <div className="p-8 glass-card border-red-500/10 hover:border-red-500/30 transition-colors group relative overflow-hidden">
                ...
                <h3 className="text-xl font-bold mb-3 flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-red-500" />
                  Não é Ferramenta Contábil
                </h3>
                <p className="text-gray-400 text-sm leading-relaxed">
                  Não substituímos o trabalho de um contador para fins fiscais complexos. Automatizamos a leitura e cálculo de ofícios do TJSP.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16">
          <div className="max-w-3xl mx-auto px-4">
            ...
            <div className="glass-card p-8">
              <FAQItem 
                question="O que é o JusIn - Cálculo para Precatórios?"
              ...
              />
              <FAQItem 
                question="Para quem o JusIn - Cálculo para Precatórios é indicado?"
